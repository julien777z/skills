...
Supporting sources: the `roblox-studio` skill's `isolated-testing` and `hidden-vm-viewer` references cover runner ownership, preservation, and capture limits. The [Tart recovery-partition explanation](https://github.com/openai/tart/issues/1232#issuecomment-4449144329) describes the base-image update prerequisite. The [Tart graphics compatibility discussion](https://github.com/openai/tart/issues/1032) notes dependence on guest and host OS versions; it does not diagnose this defect.
